...
// void *receiver_run_thread(void *thread_arg)
// {
//     struct _r_r_arg *data;
//     data = ( struct _r_r_arg * ) thread_arg;
// //    struct receiver *rx = &data->rx;
//     int len_t = data->len;
//     fprintf(stderr,"*Receiver_run_thread len = %i\n", len_t );
//     receiver_run( data->rx, data->buf, data->len);
//     
//     pthread_exit(NULL);
// }
#define	INC	16
